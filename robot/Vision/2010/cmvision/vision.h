...
#ifndef ROBOCUP2010___VISION_H__
#define ROBOCUP2010___VISION_H__

#include "cmvision.h"
#include "Vision/2010/cmvision/shared/crc32.h"
#include "Vision/SegmentedImage/SegmentedImage.h"
#include "Vision/shared/Colors.h"
#include "Vision/2010/shared/visionconstants.h"
...
public:
  ...
  int frame,field;
public:
  LowVision(ConfigFile & configFile, Log & log);
