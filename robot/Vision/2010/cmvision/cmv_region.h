...
#ifndef ROBOCUP2010___CMV_REGION_H__
#define ROBOCUP2010___CMV_REGION_H__
...
{
  //Note from Som: printing of debug lines will probably be messed up with the log
...
//   tree-based union find before you touch it
{
  ...
  while(l1 < num){
    /*
#ifdef LOGGING
    LOG_DEBUG("%6d:(%3d,%3d,%3d) %6d:(%3d,%3d,%3d)\n",
...
#ifdef LOGGING
// 	  LOG_ERROR("Options error: %2d (%3d %3d %3d) '%s' %d\n",
// 	            idx,r,g,b,name,ms)
#endif
	}
      }
