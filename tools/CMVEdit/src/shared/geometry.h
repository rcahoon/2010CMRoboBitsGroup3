...
typedef Quaternion<float> quaternf;
#endif
...
// Depricated; should not really be defined here
struct WorldParam{
  // world is assumed to be centered on (0,0)
  vector2d radius; //!< half length (x) and half height (y) of world
};
