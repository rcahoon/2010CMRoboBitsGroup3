#ifndef _INCLUDED_RUNNING_QUEUE_H_
#define _INCLUDED_RUNNING_QUEUE_H_
...
public:
  ...
  void clear()
    {start=num=0;}
  void reset()
    {delete[](arr); arr=NULL; start=num=0;}
...
{
  if(arr == NULL) arr = new data_t[MaxSize];
  return(arr == NULL);
}
